...
DLLAPT long OP_AddDict(libop* _op, long idx, const wchar_t* dict_info);
...
DLLAPT long OP_ClearDict(libop* _op, long idx);
...
DLLAPT int OP_FetchWord(libop* _op, long x1, long y1, long x2, long y2, const wchar_t* color, const wchar_t* word, wchar_t* _pStr, int _nSize);
...
DLLAPT int OP_FindPicS(libop* _op, long x1, long y1, long x2, long y2, const wchar_t* files, const wchar_t* delta_color, double sim, long dir, long* x, long* y, wchar_t* _pStr, int _nSize);
...
DLLAPT long OP_GetDictCount(libop* _op, long idx);
...
DLLAPT long OP_GetNowDict(libop* _op);
